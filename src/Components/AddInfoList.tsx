...
import {SafeAreaView, StyleSheet, Text, View, Image, Touchable, TouchableOpacity, Dimensions, ScrollView, Keyboard, KeyboardAvoidingView, Platform, Linking, Alert } from 'react-native';
import {
  HomeScreens,
  HomeStackParamList,
...
const AddInfoList = (Props:any) => {
    ...
    return (
        <>
        <Text style={styles.subInfoTitle}>추가정보</Text>
        
        {addInfoList.map((subContent, key) => {
          return (
            <View style={styles.subContentWrap}>
              <View>
                <Text style={styles.contentTitle}>{subContent.title}</Text>
                <Text>{subContent.content}</Text>
              </View>
              
              <View style={styles.btnWrap}>
                <TouchableOpacity onPress={() => {
                  setEditModalOpen(true), setSubEditData(subContent)
                }}>
                  <Image 
